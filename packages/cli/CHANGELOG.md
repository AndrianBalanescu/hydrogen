...
- GraphQL access denied error is now handled as an expected user error ([#3654](https://github.com/Shopify/hydrogen/pull/3654)) by [@lucyxiang](https://github.com/lucyxiang)
